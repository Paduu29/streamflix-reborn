...
import com.streamflixrevanced.streamflix.models.Video.Type.Episode
...
object EpisodeManager {
    ...
    fun convertToVideoTypeEpisodes(episodes: List<com.streamflixrevanced.streamflix.models.Episode>, database: AppDatabase, seasonNumber: Int): List<Episode> {
