...
import com.streamflixrevanced.streamflix.databinding.ItemSettingMobileBinding
import com.streamflixrevanced.streamflix.databinding.ViewPlayerSettingsMobileBinding
import com.streamflixrevanced.streamflix.utils.dp
import com.streamflixrevanced.streamflix.utils.margin
                ...
                setOnClickListener {
                    when (item) {
                        ...
                        is Settings.Gestures -> {
                            when (item) {
                                is Settings.Gestures.On -> com.streamflixrevanced.streamflix.utils.UserPreferences.playerGestures = true
                                is Settings.Gestures.Off -> com.streamflixrevanced.streamflix.utils.UserPreferences.playerGestures = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
                        ...
                        is Settings.KeepScreenOn -> {
                            when (item) {
                                is Settings.KeepScreenOn.On -> com.streamflixrevanced.streamflix.utils.UserPreferences.keepScreenOnWhenPaused = true
                                is Settings.KeepScreenOn.Off -> com.streamflixrevanced.streamflix.utils.UserPreferences.keepScreenOnWhenPaused = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
