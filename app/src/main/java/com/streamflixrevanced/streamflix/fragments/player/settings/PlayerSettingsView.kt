package com.streamflixrevanced.streamflix.fragments.player.settings
...
import com.streamflixrevanced.streamflix.utils.mediaServers
...
import com.streamflixrevanced.streamflix.utils.findClosest
import com.streamflixrevanced.streamflix.utils.getAlpha
import com.streamflixrevanced.streamflix.utils.getRgb
import com.streamflixrevanced.streamflix.utils.mediaServerId
import com.streamflixrevanced.streamflix.utils.mediaServers
import com.streamflixrevanced.streamflix.utils.setAlpha
import com.streamflixrevanced.streamflix.utils.setRgb
import com.streamflixrevanced.streamflix.utils.supportedTrackFormats
        ...
        sealed class Subtitle : Item {
            ...
            sealed class OpenSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(openSubtitles: List<com.streamflixrevanced.streamflix.utils.OpenSubtitles.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val openSubtitle: com.streamflixrevanced.streamflix.utils.OpenSubtitles.Subtitle
                ) : OpenSubtitles()
            }
            ...
            sealed class SubDLSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(subDLSubtitles: List<com.streamflixrevanced.streamflix.utils.SubDL.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val subDLSubtitle: com.streamflixrevanced.streamflix.utils.SubDL.Subtitle
                ) : SubDLSubtitles()
            }
        }
