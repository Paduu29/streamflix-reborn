...
import com.streamflixrevanced.streamflix.activities.main.MainTvActivity
import com.streamflixrevanced.streamflix.backup.BackupRestoreManager
import com.streamflixrevanced.streamflix.backup.ProviderBackupContext
import com.streamflixrevanced.streamflix.database.AppDatabase
import com.streamflixrevanced.streamflix.database.dao.EpisodeDao
import com.streamflixrevanced.streamflix.database.dao.MovieDao
...
import com.streamflixrevanced.streamflix.utils.QrUtils
...
class SettingsTvFragment : LeanbackPreferenceFragmentCompat() {
    ...
    private fun displaySettings() {
        ...
        findPreference<Preference>("p_settings_telegram")?.setOnPreferenceClickListener {
            try {
                val tgIntent = Intent(Intent.ACTION_VIEW, Uri.parse("tg://resolve?domain=streamflixrevanced"))
                startActivity(tgIntent)
            } catch (e: Exception) {
                Toast.makeText(requireContext(), "Telegram not found.", Toast.LENGTH_SHORT).show()
                val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://t.me/streamflixrevanced"))
